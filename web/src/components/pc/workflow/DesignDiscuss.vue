      ...
      this.wsUnsubscribe = api.wsSubscribe(this.currentDiscussion.sessionId, {
        ...
        step: (data) => {
          ...
          if (hasExecuting) {
            ...
            this.logItems.push({
              type: 'step',
              thought: data.reasoning || data.thought,
...
.chat-input-area { padding: 12px 16px; background: var(--color-panelHeader); border-top: 1px solid var(--color-contentBg); flex-shrink: 0; }
